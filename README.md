...
Backend:
- Laravel - RESTful API for business logic
...
## Description
A monolithic application with frontend and backend for managing contacts. Some of the functionalities of the project:
